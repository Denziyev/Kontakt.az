...
{
    /// <inheritdoc />
    public partial class UpdatedProducttTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialPayment = table.Column<double>(type: "float", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountinCash = table.Column<double>(type: "float", nullable: false),
                    BrandId = table.Column<int>(type: "int", nullable: false),
                    StockNumber = table.Column<int>(type: "int", nullable: false),
                    DiscountofProductId = table.Column<int>(type: "int", nullable: false),
                    DiscountofProductId1 = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_DiscountofProducts_DiscountofProductId",
                        column: x => x.DiscountofProductId,
                        principalTable: "DiscountofProducts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_DiscountofProducts_DiscountofProductId1",
                        column: x => x.DiscountofProductId1,
                        principalTable: "DiscountofProducts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCredits", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_DiscountofProductId",
                table: "Products",
                column: "DiscountofProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_DiscountofProductId1",
                table: "Products",
                column: "DiscountofProductId1");
